...
module lab3_zw_tb();
    ...
    initial begin
        ...
        // Wait for the debouncer to confirm PRESSED, then wait for keypad_scanner
        // to reach HOLD (SCAN -> PRESS -> HOLD with digit0 <= key).
        ...
        wait (dut.kp_scanner.state == dut.kp_scanner.HOLD);
        #1;
